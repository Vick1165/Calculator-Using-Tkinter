...
Button(root,text="=",command = lambda :calclulate()).grid(row=5,column=2)
...
Button(root,text="pi",command = lambda :get_operation("*3.41")).grid(row=2,column=4)
